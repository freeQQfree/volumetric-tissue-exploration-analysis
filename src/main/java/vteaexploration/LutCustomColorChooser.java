 ...
 * @author sukhoc
 */
public class LutCustomColorChooser extends JPanel implements ChangeListener, CustomLutListener {
    ...
    JButton okButton;
    PlotAxesSetup axesSetup;
    private ArrayList<CustomLutListener> CustomLutListeners = new ArrayList<CustomLutListener>();
...
//        bannerPanel.setBorder(BorderFactory.createTitledBorder("Banner"));
    ...
    private void createAndShowGUI() {
        ...
        JComponent newContentPane = new LutCustomColorChooser(this.clusterInfo);
...
//        });
    ...
    public void registerAxesSetup(PlotAxesSetup axesSetup){
        this.CustomLutListeners.add(axesSetup);
    }
